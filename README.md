...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            OAuth(GitHub/Google/Kakao/Naver) 소셜 로그인 및 JWT 인증 체계 구축<br/>
            Next.js 16 + Express 5 풀스택 아키텍처, Docker/Nginx 배포 환경 구성
        </td>
        <td>
            <a href="https://github.com/kwangche/Aiknown">Repo</a><br/>
            <a href="https://aiknown.netlify.app">Demo</a>
        </td>
    </tr>
    <tr>
        <td><b>고급</b></td>
        <td><b>무빙</b><br/>(이사 매칭 플랫폼)</td>
        <td>
